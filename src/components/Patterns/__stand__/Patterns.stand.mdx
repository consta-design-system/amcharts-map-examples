...
Вы можете добавить к элементу какой-то паттерн: заполнить его линиями, куржочками или любым изображением.
...
Чтобы применить паттерн к элементу, нужно сделать две вещи:
